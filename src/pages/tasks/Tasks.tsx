...
import { Icon, Sparkle, Badge, CheckCircle } from '../../components/ui'
    ...
    <div style={{ display: 'grid', gridTemplateColumns: '220px 1fr', height: '100%', background: 'var(--bg-base)', overflow: 'hidden' }}>
      ...
      <main style={{ display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <header style={{ height: 56, borderBottom: '1px solid var(--bd-default)', display: 'flex', alignItems: 'center', padding: '0 28px', gap: 14, background: 'var(--bg-surface)', flexShrink: 0 }}>
          ...
          <div style={{ flex: 1 }} />
          <div style={{ width: 260, height: 34, background: 'var(--bg-base)', border: '1px solid var(--bd-default)', borderRadius: 8, display: 'flex', alignItems: 'center', padding: '0 12px', gap: 8 }}>
        ...
        <div className="scroll" style={{ flex: 1, overflow: 'auto', display: 'grid', gridTemplateColumns: '180px 1fr' }}>
          {/* Sidebar de disciplinas */}
          <div style={{ borderRight: '1px solid var(--bd-default)', padding: '16px 12px', background: 'var(--bg-surface)' }}>
            ...
            <button onClick={() => setFilterDisc(null)} style={{
              ...
              border: 'none', borderRadius: 6, cursor: 'pointer', color: 'var(--tx-1)', fontSize: 13, textAlign: 'left',
            }}>
          ...
          {/* Main content */}
          <div className="scroll" style={{ overflow: 'auto', padding: '24px 28px 32px' }}>
            {/* AI urgency banner */}
            <div style={{
              background: 'linear-gradient(135deg, rgba(245,158,11,0.10), rgba(245,158,11,0.04))',
              border: '1px solid rgba(245,158,11,0.32)', borderLeft: '3px solid var(--c-warning)',
              ...
              <div style={{ padding: '12px 18px', borderBottom: '1px solid var(--bd-default)', display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                {filterDisc && (
                  <span className="badge badge-normal" style={{ display: 'inline-flex', alignItems: 'center', gap: 4 }}>
                    ...
                    {filterDisc}
                    <button onClick={() => setFilterDisc(null)} style={{ background: 'none', border: 'none', padding: 0, cursor: 'pointer', display: 'inline-flex' }}><Icon name="x" size={11} /></button>
                  </span>
                )}
                <div style={{ flex: 1 }} />
              ...
              {listTasks.map((t, i) => {
                ...
                return (
                  <div key={t.id} style={{
                    ...
                    opacity: checked ? 0.5 : 1, cursor: 'pointer', transition: 'background 120ms',
                  }}
                  ...
                  >
                    ...
                    <span style={{ fontSize: 12, color: 'var(--tx-2)', minWidth: 80, textAlign: 'right' }}>
